// RaeenOS Font Engine - 8x8 Bitmap Font
...
static const uint8_t font_data[95][8] = {
    ...
    {0x00, 0x00, 0x00, 0x5f, 0x00, 0x00, 0x00, 0x00}, // 33: !
    ...
    {0x08, 0x04, 0x08, 0x10, 0x08, 0x04, 0x08, 0x00}  // 126: ~
};
...
const uint8_t* font_get_char(char c) {
    ...
    return NULL; // Return NULL for non-printable characters
}
